// Node: Fetch Adzuna US-2 (companies 18–33, US only)
//
// Continues the Adzuna US fetch for the remaining 16 companies.
// Same logic as US-1; split to stay within the 60s node timeout.
...
for (const company of adzunaCompanies.slice(17)) {
  try {
